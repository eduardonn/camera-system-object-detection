...
class DetectionTester:
    ...
    def updateFakeDetection(self, frame):
        ...
        for gatilho in gatilhos.listaGatilhos:
            ...
            if (self.startPoint[0] >= (gatilho.areaStartX * w)) & (self.endPoint[0] <= (gatilho.areaEndX * w)) & (self.startPoint[1] >= (gatilho.areaStartY * h)) & (self.endPoint[1] <= (gatilho.areaEndY * h)):
                areaColor = (0, 200, 0)
            else:
                areaColor = (200, 0, 0)
